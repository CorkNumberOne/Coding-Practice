...
- transcript text and video metadata when automatic punctuation cleanup is needed;
...
- transcript text plus relevant video metadata when restoring punctuation;
