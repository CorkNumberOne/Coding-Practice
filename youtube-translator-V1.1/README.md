...
- In bilingual mode, active YouTube captions in the player become timed English and Chinese subtitles.
- Restore readable punctuation and sentence boundaries when Supadata returns fragmented automatic-caption text.
- Translate visible Overview and Notes content progressively in small cached batches.
- Explain selected transcript text in Chinese and English, or save it directly as a timestamped note.
...
5. Select transcript text when you want a concise Chinese and English AI explanation.
...
- Original, Simplified Chinese, and aligned bilingual transcript views, including active player captions.
